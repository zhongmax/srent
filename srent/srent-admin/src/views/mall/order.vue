<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="支付金额" prop="freightPrice" />

      <el-table-column align="center" label="支付时间" prop="addTime" />

      <el-table-column align="center" label="交易方式" prop="type">
        <template slot-scope="scope">
          <el-tag>{{ scope.row.type | transactionFilter }}</el-tag>
        </template>
      </el-table-column>
