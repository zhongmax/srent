    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" property="iconUrl" label="图片">
        <template slot-scope="scope">
          <img :src="scope.row.gallery[0]" width="40">
        </template>
      </el-table-column>

      <el-table-column align="center" label="押金" prop="deposit" />

      <el-table-column align="center" label="每日租金" prop="rentPrice" />

      <el-table-column align="center" label="分类" prop="keywords">
      </el-table-column>

      <el-table-column align="center" label="发布时间" prop="addTime" />

      <el-table-column align="center" label="是否租出" prop="rented">
        <template slot-scope="scope">
          <el-tag :type="scope.row.rented ? 'error' : 'success' ">{{ scope.row.rented ? '租出' : '未租' }}</el-tag>
        </template>
      </el-table-column>
