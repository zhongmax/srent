...
import com.csmaxwell.srent.db.service.SrentUserFormIdService;
...
public class WxTemplateSender {
    ...
    @Autowired
    private SrentUserFormIdService formIdService;
    ...
    private void sendMsg(String touser, String templatId, String[] parms,
                         String page, String color, String emphasisKeyword) {
        SrentUserFormid userFormid = formIdService.queryByOpenId(touser);
        if (userFormid == null)
            return ;
