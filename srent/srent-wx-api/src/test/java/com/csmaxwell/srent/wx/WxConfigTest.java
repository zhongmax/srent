...
public class WxConfigTest {
    ...
    public void test() {
        ...
        System.out.println(environment.getProperty("srent.wx.app-id"));
        // 测试获取application-wx.yml配置信息
        System.out.println(environment.getProperty("srent.wx.notify-url"));
        // 测试获取application.yml配置信息
        System.out.println(environment.getProperty("logging.level.com" +
                ".csmaxwell.srent.wx"));
    }
